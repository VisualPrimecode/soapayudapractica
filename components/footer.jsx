            ...
            <div className={` relative py-6 w-full flex flex-col md:flex-row md:justify-evenly items-center gap-6 md:gap-0 text-lg text-white text-opacity-80 text-center `}>
                ...
                <section className="relative">
                    ...
                    <div className="w-full">
                        <p className="mx-3 font-semibold mt-2">© 2022 SOAP AYUDA.</p>
                        <p className="mx-3 font-normal">Creado por <span className={` text-nowrap`}>Seguro Obligatorio</span></p>
                    </div>
                </section>

                <section className="relative">
                    <p className="mx-3 h-auto md:h-16 flex justify-center items-center">
                    ...
                    <address className=" not-italic mt-2 mx-3">
