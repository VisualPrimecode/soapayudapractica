                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-0 my-10 text-center m-4 font-bold text-lg">
                    ...
                    <div>
                        ...
                        <div className=" text-left mx-8 text-lg md:text-xl duration-300 ease-in-out block">
                            <p className="grid grid-cols-2 text-[#1e5db2]"><span className="inline-block text-left">Autos, Jeep y Station Wagon</span> <span className="inline-block text-right">$8.500</span></p>
                    ...
                    <div>
                        ...
                        <div className=" text-left mx-8 text-lg md:text-xl duration-300 ease-in-out block">
                            <p className="grid grid-cols-2 text-[#1e5db2]"><span className="inline-block text-left">Camión y Tracto</span> <span className="inline-block text-right">$25.000</span></p>
                            <p className="grid grid-cols-2 text-[#22beeb]"><span className="inline-block text-left">Remolque, Semi remolque y Rampla</span> <span className="inline-block text-right">$8.500</span></p>
                            <p className="grid grid-cols-2 text-[#1e5db2]"><span className="inline-block text-left">Maquinaria Industrial</span> <span className="inline-block text-right">$11.000</span></p>
                            <p className="grid grid-cols-2 text-[#22beeb]"><span className="inline-block text-left">Maquinaria Agrícola</span> <span className="inline-block text-right">$11.000</span></p>
                        </div>
                    </div>

                </div>
                <p className=" text-center m-8 px-8 max-w-screen-sm mx-auto"><Link href="https://soapweb.bciseguros.cl/web/DatosVehiculo?Convenios=4E4BB8F4BC6D5C22C0661F4F8D3ADF2E" className="inline-block rounded-full px-4 w-[100%] pt-1 pb-2 bg-[linear-gradient(#22beeb,#1e5db2)] text-white text-lg md:text-xl no-underline font-medium" >Paga to SOAP aquí</Link></p>
            </section>
