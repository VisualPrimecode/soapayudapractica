...
export const metadata = {
    title: 'Mutal de Seguridad | Fundación Apoyándote'
};
    ...
    return (
        ...
        <main className="text-center">
            ...
            <section className=" text-center mt-16 mb-24 max-w-screen-lg mx-auto">
                ...
                <p className=" text-center m-8 px-8 max-w-screen-sm mx-auto"><Link href="https://core.mutualdeseguros.cl/soap_ms/pago.php?tipodeventa=244" className="inline-block rounded-full px-4 w-[100%] pt-1 pb-2 bg-[linear-gradient(#22beeb,#1e5db2)] text-white text-lg md:text-xl no-underline font-medium" >Paga to SOAP aquí</Link></p>
            </section>
